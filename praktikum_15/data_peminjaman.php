                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            ?>
                                        <button <?= $s ?> type="button" class="btn btn-primary" name="edit"
                                        ...
                                        <button <?= $s ?> type="button" class="btn btn-warning" name="setujui"
                                            data-bs-toggle="modal"
                                            data-bs-target="#ModalSetujui<?= $query['kode_barang']; ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
