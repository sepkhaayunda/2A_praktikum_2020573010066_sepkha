        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="card">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input type="datetime-local" class="form-control"
                                                    name="waktu_pengembalian" id="floatingInput">
                                ...
                                <form action="proses/proses_hapus_peminjaman.php" method="POST">
                                    <div class="modal-body">
                                        <input type="hidden" name="id_peminjaman"
                                            value="<?= $query['id_peminjaman'] ?>">
                                        <p style="color: red;">Apakah anda akan menghapus data peminjaman barang
                    ...
                    <!-- modal Kembalikan -->
                    <div class="modal fade" id="ModalKembalikan<?= $query['kode_barang']; ?>" tabindex="-1"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <form action="proses/proses_kembalikan_peminjaman.php" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Close</button>
                                        <input type="submit" class="btn btn-secondary" name="kembalikan"
                                            value="Kembalikan">
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="modal fade" id="ModalProsesKembalikan<?= $query['kode_barang']; ?>" tabindex="-1"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <form action="proses/proses_setuju_kembalikan_peminjaman.php" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Close</button>
                                        <input type="submit" class="btn btn-secondary" name="setuju_kembalikan"
                                            value="Setuju Dikembalikan">
                                    </div>
                                </form>
                            </div>
                        </div>
