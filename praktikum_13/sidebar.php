...
<div class="d-flex flex-column flex-shrink-0 p-3" style="background-color:#ECD4FF;" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        ?>
            <li>
                <a href="data_peminjaman" class="nav-link link-dark 
                <?php if ($_GET['x'] == 'data_peminjaman')  echo 'active'; ?>
                ">
                    <svg class="bi me-2" width="16" height="16">
