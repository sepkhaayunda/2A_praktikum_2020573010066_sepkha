...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> Merchandiseofficial.com</li>
                <li>Start from 100k</li>
            </ul>
        </div>
    </div>
    <!-- Humberger End -->
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        ...
                        <div class="header__cart__price">item: <span>7.7 45%</span></div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            <li><a href="#">NCT</a></li>
                            <li><a href="#">EXO</a></li>
                            <li><a href="#">SM Stan</a></li>
                            <li><a href="#">AESPA</a></li>
                            <li><a href="#">SUPERJUNIOR</a></li>
                            <li><a href="#">SNSD</a></li>
                            <li><a href="#">SHINee</a></li>
                            <li><a href="#">Kang Soo Man</a></li>
                            <li><a href="#">Red Velvet</a></li>
                            <li><a href="#">Taeyeon</a></li>
                            <li><a href="#">S.E.S</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-9">
                    <div class="hero__search">
                        ...
                        <div class="hero__search__phone">
                            ...
                            <div class="hero__search__phone__text">
                                <h5>+62 852 6052 1163</h5>
                                <span>Melayani Jam Kerja</span>
                            </div>
                        </div>
                    </div>
                    <div class="hero__item set-bg" data-setbg="{{ asset('frontend/img/hero/banner.jpg') }}">
                        <div class="hero__text">
                            <span> SUMMER FRESH </span>
                            <h2>Special <br />Comeback 2022</h2>
                            <p>Free Photocard and Poster</p>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <li data-filter=".oranges">NCT</li>
                            <li data-filter=".fresh-meat">EXO</li>
                            <li data-filter=".vegetables">AESPA</li>
                            <li data-filter=".fastfood">REDVELVET</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="row featured__filter">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat vegetables">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">JISUNG KEY_RING</a></h6>
                            <h5>RP30.000</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            ...
                            <h5><a href="#">PESAN ANTAR KEMANA SAJA</a></h5>
                            <p>Paket Aman untuk diantar keseluruh wilayah Indonesia </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            ...
                            <h5><a href="#">AVAILABLE COD</a></h5>
                            <p>Pulau Jawa dan Sumatra dapat melakukan pemesanan Cash On Delivery </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            ...
                            <h5><a href="#">LIMITED</a></h5>
                            <p>Merchandise yang dijual merupakan keluaran Official yang sangat Limited Edition </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Address: Jln.Kenari Lt.3 Mall Kenari Official Office IND</li>
                            <li>Phone: +62 852 6052 1163</li>
                            <li>Email: Merchandiseofficial.com</li>
                        </ul>
                    </div>
                </div>
