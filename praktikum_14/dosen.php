    ...
    <div class="container-fluid bg-light">
        <div class="row">
            ...
            <div class="col-9 mt-4">
                <div class="card">
                    <h5 class="card-header" style="background-color:#ECD4FF;">Data Dosen</h5>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <button type="button" class="btn btn-primary ms-2" name="edit"
                                                data-bs-toggle="modal" data-bs-target="#ModalEdit<?= $no; ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <!-- modal edit -->
                                    <div class="modal fade" id="ModalEdit<?= $no; ?>" tabindex="-1"
                                                    ...
                                                    <form action="proses/proses_edit_dosen.php" method="POST"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="form-floating mb-2">
                                                                    <input type="text" class="form-control" name="nama"
                                                                        id="floatingInput" value="<?= $query['nama_dosen'] ?>"
                                                                        autofocus>
                                                                    <label for="floatingInput">Nama</label>
                                                                </div>
                                                            </div>
                                    ...
                                    <!-- modal hapus -->
                                    <div class="modal fade" id="ModalDelete<?= $no; ?>" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <!-- modal detail -->
                                    <div class="modal fade" id="ModalDetail<?= $no; ?>" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
